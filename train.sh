...
python biobert/run_ner.py \
	   ...
	   --do_test=$dotest \
	   --use_tpu=true \
	   --vocab_file=PRETRAINED_DIR/$pretrained/vocab.txt \
	   --bert_config_file=PRETRAINED_DIR/$pretrained/bert_config.json \
	   --init_checkpoint=PRETRAINED_DIR/$pretrained/bert_model.ckpt \
